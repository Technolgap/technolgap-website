...
const About = () => <Layout>
    ...
    <Title titleTop={800} text={<h1>the problem</h1>}/>
    ...
    <Title titleTop={1450} text={<h1>technolgap's mission</h1>}/>
    <Programs /> 
    <ExecutiveTeam />
    </Layout>;
